...
fetch_csv_path = current_dir.parent.parent/ "csv" / "Coca" / "completerawdata.csv"
...
LSTMpath = current_dir.parent.parent / "csv" / "Coca"/ "LSTMdata.csv"
XGBoostpath = current_dir.parent.parent / "csv" / "Coca" / "XGBoostdata.csv"
