...
df_normalizedXGBoost['target'] = np.where(
    df_normalizedXGBoost['close'] > df_normalizedXGBoost['close'].shift(1),
    1,  # Up
    0   # Down
)
...
LSTMpath = current_dir.parent.parent / "csv" / "Johnson and Johnson"/"LSTMdata.csv"
XGBoostpath = current_dir.parent.parent / "csv" / "Johnson and Johnson"/"XGBoostdata.csv"
XGBoostv2path = current_dir.parent.parent / "csv" / "Johnson and Johnson"/"xgboostv2.csv"
